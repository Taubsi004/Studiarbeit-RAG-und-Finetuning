...
\paragraph{K1 -- Aktualität und Dynamik des Wissens.}\label{krit:k1}
...
\paragraph{K2 -- Wissensvolumen und Skalierbarkeit.}\label{krit:k2}
...
\paragraph{K3 -- Strukturgrad des Wissens.}\label{krit:k3}
...
\paragraph{K4 -- Faktentreue und Provenance.}\label{krit:k4}
...
\paragraph{K5 -- Art der Aufgabe.}\label{krit:k5}
...
\paragraph{K6 -- Multi-Hop-Reasoning.}\label{krit:k6}
...
\paragraph{K7 -- Domänenspezifische Sprache und Terminologie.}\label{krit:k7}
...
\paragraph{K8 -- Rechenressourcen.}\label{krit:k8}
...
\paragraph{K9 -- Datenaufwand.}\label{krit:k9}
...
\paragraph{K10 -- Wartung und Betriebskosten.}\label{krit:k10}
...
\paragraph{K11 -- Latenz und Performance.}\label{krit:k11}
...
\paragraph{K12 -- Datenschutz, DSGVO und EU AI Act.}\label{krit:k12}
...
\paragraph{K13 -- Auditierbarkeit und Erklärbarkeit.}\label{krit:k13}
...
\paragraph{K14 -- Verfügbarkeit von Fachexpertise.}\label{krit:k14}
...
\paragraph{K15 -- Vendor Lock-in und Modellzugang.}\label{krit:k15}
