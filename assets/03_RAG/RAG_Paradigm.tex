...
% ================= NAIVE RAG =================
\node[title] (TitleNaive) at (1.3, 0) {Naive RAG};

\node[box] (N_User) at (0, -1.5) {Nutzer-\\anfrage};
\node[box] (N_Doc) at (2.6, -1.5) {Daten-\\quellen};

\node[box] (N_Idx) at (2.6, -3) {Indexierung};
\node[box, minimum width=5.2cm] (N_Ret) at (1.3, -5) {Retrieval};
\node[box, minimum width=5.2cm] (N_Gen) at (1.3, -7.5) {Generierung (LLM)};
\node[box, minimum width=5.2cm] (N_Out) at (1.3, -9) {Antwort};
...
\begin{scope}[on background layer]
    \node[panel, fit=(TitleNaive) (N_User) (N_Doc) (N_Out)] (PanelNaive) {};
\end{scope}


% ================= ADVANCED RAG =================
\node[title] (TitleAdv) at (8.3, 0) {Advanced RAG};

\node[box] (A_User) at (7, -1.5) {Nutzer-\\anfrage};
\node[box] (A_Doc) at (9.6, -1.5) {Daten-\\quellen};

\node[optbox] (A_Pre) at (7, -3.2) {Pre-Retrieval\\[1mm]\normalfont\scriptsize(z.B. Rewrite, Expand)};
\node[box] (A_Idx) at (9.6, -3.2) {Indexierung};

\node[box, minimum width=5.2cm] (A_Ret) at (8.3, -5) {Retrieval};

\node[optbox, minimum width=5.2cm] (A_Post) at (8.3, -6.5) {Post-Retrieval\\[1mm]\normalfont\scriptsize(Reranking, Kompression)};

\node[box, minimum width=5.2cm] (A_Gen) at (8.3, -8) {Generierung (LLM)};
\node[box, minimum width=5.2cm] (A_Out) at (8.3, -9.5) {Antwort};
...
\begin{scope}[on background layer]
    \node[panel, fit=(TitleAdv) (A_User) (A_Doc) (A_Out)] (PanelAdv) {};
\end{scope}


% ================= MODULAR RAG =================
\node[title] (TitleMod) at (16, 0) {Modular RAG};

\node[rectangle, draw=blue!30, fill=white, dashed, rounded corners=8pt, minimum width=7cm, minimum height=8.2cm, thick] (ModBox) at (16, -5.5) {};
...
\node[font=\sffamily\LARGE\bfseries, text=blue!15] at (16, -5.5) {RAG};

% Inner ring
\node[modbox, draw=orange!80, fill=orange!5] (M_Ret) at (16, -4) {Retrieve};
\node[modbox, draw=orange!80, fill=orange!5] (M_Read) at (16, -7) {Read};
\node[modbox] (M_Rewrite) at (14, -5.5) {Rewrite};
\node[modbox] (M_Rerank) at (18, -5.5) {Rerank};

% Outer ring
\node[modbox] (M_Search) at (16, -2.3) {Search};
\node[modbox] (M_Mem) at (16, -8.7) {Memory};
\node[modbox] (M_Route) at (13.5, -3) {Routing};
\node[modbox] (M_Predict) at (18.5, -3) {Predict};
\node[modbox] (M_Demo) at (13.5, -8) {Demonstrate};
\node[modbox] (M_Fusion) at (18.5, -8) {Fusion};
...
\begin{scope}[on background layer]
    \node[panel, fit=(TitleMod) (ModBox)] (PanelMod) {};
\end{scope}
